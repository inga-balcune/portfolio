            ...
            <div class="contact__form">
                <form
                    ...
                    <div class="form form__group">
                        ...
                        <input 
                            ...
                            v-model='firstName'>
                        <p class='form__input--warning' v-if="$v.firstName.$error">Please provide your name</p>
                    </div>
                    ...
                    <input 
                        ...
                        v-model='lastName'>
                        <p class='form__input--warning' v-if="$v.lastName.$error">Please provide your surname</p>
                    </div>
                    ...
                    <div class="form__group">
                        ...
                        @input="$v.email.$touch()"
                        v-model='email'>
                        <p class='form__input--warning' v-if="!$v.email.email">Please provide a valid email address</p>
                    </div>
                ...
                <div class='confirmation' v-else>
                    ...
                    <div class='confirmation__text-box'>
                        <p class='heading-tertiary u-margin-bottom-small'>I have received your text with the following details:</p>
                        ...
                        <p class='heading-tertiary u-margin-top-small'>I'll get back to you asap!</p>
                    </div>
                </div>
            </div>
